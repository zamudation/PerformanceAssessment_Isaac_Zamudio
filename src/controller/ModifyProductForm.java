...
public class ModifyProductForm implements Initializable {
    ...
    /**
     * This setProductIndex method sets the index to the productIndex parameter
     */
    public static void setProductIndex (int index){
        productIndex = index;
    }

    /**
     * This modifyProduct method sets the productSelected to the product parameter
     */
    public static void modifyProduct(Product productSelected) {
    ...
    /**
     * This sets up the form ith all the information for th parts table and the information of the
     * product selected
     */
    @Override
    ...
    /**
     * This removingAssocPart action event button removes the associated part that has been selected
     */
    public void removingAssocPart(ActionEvent actionEvent) {
        Part removePart = (Part) aPartsTable.getSelectionModel().getSelectedItem();
        ...
        if (!( removePart == null)) {
            ...
            if(result.get() == ButtonType.OK) {
                boolean delete = product.deleteAssociatedPart(removePart);
                //aPartList.remove(removePart);
            }
        }
    }

    /**
     * This saveProduct action event saves the changes o the product selected into the allParts list, but first
    ...
    public void saveProduct(ActionEvent actionEvent) throws IOException {
        ...
        if (!errorBool) {
            Product changedProduct = new Product(product.getId(), nameTextField.getText().trim(),
            ...
            for (Part p : aPartList) {
                changedProduct.addAssociatedPart(p);
            }

            Inventory.updateProduct(productIndex, changedProduct);
